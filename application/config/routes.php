...
// Frontend routes - sử dụng Home controller
$route['gioi-thieu'] = 'home/about';
$route['products'] = 'home/products';
$route['tin-tuc'] = 'home/news';
$route['lien-he-moi'] = 'home/contact';
$route['dang-ky-lai-thu'] = 'home/register';
$route['dai-ly'] = 'home/branch';
$route['home/check_updates'] = 'home/check_updates';
$route['home/check_banner_updates'] = 'home/check_banner_updates';
$route['home/check_news_updates'] = 'home/check_news_updates';
$route['home/check_products_page_updates'] = 'home/check_products_page_updates';

// Authentication routes
$route['login'] = 'login/index';
$route['login/authenticate'] = 'login/authenticate';
$route['logout'] = 'login/logout';
$route['register_account'] = 'registeraccount/index';
$route['register_account/create'] = 'registeraccount/create';
...
$route['product-title'] = 'producttitle';
...
$route['admin/test-users'] = 'admin/users';
...
$route['admin/users/delete'] = 'admin/delete';
$route['admin/users/view'] = 'admin/view';
$route['admin/users/edit'] = 'admin/edit';
$route['admin/users/update'] = 'admin/update';
$route['admin/products'] = 'admin/admin_products';
$route['admin/products/view'] = 'admin/view_product';
$route['admin/products/edit'] = 'admin/edit_product';
$route['admin/products/update'] = 'admin/update_product';
        $route['admin/products/delete'] = 'admin/delete_product';
        $route['admin/products/add'] = 'admin/add_product';

// Admin Stock Products routes
$route['admin/admin_stock_products'] = 'admin/admin_stock_products';
$route['admin/stock_products/view'] = 'admin/view_stock_product';
$route['admin/stock_products/edit'] = 'admin/edit_stock_product';
$route['admin/stock_products/update'] = 'admin/update_stock_product';
$route['admin/stock_products/delete'] = 'admin/delete_stock_product';
$route['admin/stock_products/add'] = 'admin/add_stock_product';
$route['admin/stock_products/test'] = 'admin/test_update';


// Admin News routes
        $route['admin/news'] = 'admin/admin_news';
        $route['admin/news/view'] = 'admin/view_news';
        $route['admin/news/edit'] = 'admin/edit_news';
        $route['admin/news/update'] = 'admin/update_news';
        $route['admin/news/delete'] = 'admin/delete_news';
        $route['admin/news/add'] = 'admin/add_news';
...
$route['gioi-thieu'] = 'evo/about';
$route['san-pham'] = 'evo/products';
$route['lien-he'] = 'evo/contact';
$route['dang-ky-lai-thu'] = 'register/index';
$route['dai-ly'] = 'evo/branch';
