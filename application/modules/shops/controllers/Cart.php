        ...
        if (!empty($row)) {
            ...
            if ($insert_new) {
                ...
                if($user_level_percent > 0){
                    $unit_price = get_discount_price_by_percent($unit_price, $user_level_percent);
                    $price = get_discount_price_by_percent($price, $user_level_percent);
                }
                $data = array(
                    'id' => $id,
                    'qty' => $qty,
                    ...
                    'url' => site_url('products' . '/' . $row['cat_alias'] . '/' . $row['alias'] . '-' . $row['id'])
                );
