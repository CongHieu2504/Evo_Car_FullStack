...
class Users extends Layout {
    ...
    function validate_login() {
        ...
        if ($row) {
            ...
            $role = $row['role'];  // Dùng role thay vì group_id
            ...
            $sess_array = array(
                ...
                'photo' => $row['photo'],
                'created' => $row['created'],
                'role' => $role,  // Dùng role thay vì group_id
                'ref' => $row['refer_key'],
            );
            $this->session->set_userdata('logged_in', $sess_array);
            return TRUE;
    ...
    function validate_admin_logged_in() {
        if (!$this->session->userdata('logged_in')) {
            ...
            $session_data = $this->session->userdata('logged_in');
            if (isset($session_data['role']) && $session_data['role'] == 'ADMIN') {  // Dùng role thay vì group_id
                return TRUE;
            } else {
                return FALSE;
            }
